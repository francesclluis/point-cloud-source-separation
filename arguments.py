...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--frame_pool', default='maxpool',
                            help="avg or max pool image features")
        parser.add_argument('--vision_activation', default='sigmoid',
        ...
        parser.add_argument('--num_val', default=-1, type=int,
                            help='number of mixtures to evalutate')
        ...
        parser.add_argument('--rgbs_feature', default=0, type=int,
                            help='use rgb values as point features')
